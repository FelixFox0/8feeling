            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <?php $image_row = 0; ?>
                    <?php //var_dump($blog_images); ?>
                    <?php foreach ($blog_images as $blog_image) { ?>
                    
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left">
                          <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $blog_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                          <input type="hidden" name="blog_image[<?php echo $image_row; ?>][image]" value="<?php echo $blog_image['image']; ?>" id="input-image<?php echo $image_row; ?>" />
                      </td>
                      <td class="text-right">
                          <input type="text" name="blog_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $blog_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" />
                      </td>
...
$('#input-type').on('change', function() {
   console.log( this.value ); // or $(this).val()
	...
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=design/blog/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
