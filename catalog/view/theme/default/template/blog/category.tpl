...
<?php if (($category_info['category_id'] !== "61")&&($category_info['category_id'] !== "62")){ ?>
<div class="content">
    ...
    <?php foreach ($posts as $key => $post) : ?>
      <div class="collections__item" style="background: url(<?php echo $post['post_thumbnail']; ?>); background-size: cover;">
        <div class="collections__info">
          ...
          <a href="<?php echo HTTP_SERVER; ?>index.php?route=blog/single&amp;pid=<?php echo $post['ID']; ?>" class="collections__item__view"><?php echo $text_button; ?></a>
        </div>
      </div>
      <?php endforeach; ?>
      <?php } ?>
          ...
          <article class="blog__item">
            ...
            <div class="blog__item__body">
              ...
              <div class="blog__item__buttons">
                ...
                <a href="<?php echo HTTP_SERVER; ?>index.php?route=blog/single&amp;pid=<?php echo $post['ID']; ?>" class="blog__item__more"><?php echo $text_read; ?></a>
              </div>
            </div>
            <div class="blog__item__date"><strong><?php echo $post['date_added']['day']; ?><span><?php echo $post['date_added']['month'];?></span></strong></div>
          </article>
          <?php endforeach; ?>
        <?php endif; ?>
